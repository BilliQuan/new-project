...
import './App.css'
import IPHONE from '../public/images/iphonex.png'
import LOGOS from '../public/images/client-logos.png'
    ...
    <div  className="bg-[#dc3491] w-full  top-0 shadow-lg">
       <div className="px-6 py-15 text-center pb-2">
        ...
        <div className="overflow-hidden h-96 w-full flex justify-center ">
          <img src={IPHONE} alt="Phone mockup" className="w-full max-w-122 object-cover object-top" />
        </div>
